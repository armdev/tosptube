...
rem set CATALINA_OPTS=%CATALINA_OPTS% -javaagent:C:/plumbr/plumbr.jar
setlocal
...
set JAVA_OPTS=%JAVA_OPTS% -Xms1024m -Xmx2048m -XX:+UseParallelGC
set JAVA_OPTS=%JAVA_OPTS% -Dorg.apache.el.parser.COERCE_TO_ZERO=false
set JAVA_OPTS=%JAVA_OPTS% -XX:PermSize=1024m -XX:MaxPermSize=2048m
